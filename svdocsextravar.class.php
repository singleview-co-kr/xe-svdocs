...
class SvdocsExtraVar
{
	...
	/**
	 * Current module's Set of SvdocsExtraItem
	 * @var SvdocsExtraItem[]
	 */
	var $keys = null;

	/**
	 * Get instance of SvdocsExtraVar (singleton)
	 *
	...
	function setExtraVarKeys($extra_keys)
	{
		...
		{
			$obj = new SvdocsExtraItem($val->module_srl, $val->idx, $val->name, $val->type, $val->default, $val->desc, $val->is_required, $val->search, $val->value, $val->eid);
			$this->keys[$val->idx] = $obj;
		}
	}

	/**
	 * Returns an array of SvdocsExtraItem
	 *
	 * @return SvdocsExtraItem[]
	 */
...
/* End of file SvdocsExtraVar.class.php */
/* Location: ./modules/svdocs/SvdocsExtraVar.class.php */